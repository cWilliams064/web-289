...
<?php if (!empty($errors['firstName'])): ?>
  <?= '<p class="create-user-errors">' . $errors['firstName'] . '</p>'; ?>
<?php endif; ?>
...
<?php if (!empty($errors['lastName'])): ?>
  <?= '<p class="create-user-errors">' . $errors['lastName'] . '</p>'; ?>
<?php endif; ?>
...
<?php if (!empty($errors['username'])): ?>
  <?= '<p class="create-user-errors">' . $errors['username'] . '</p>'; ?>
<?php endif; ?>
...
<?php if (!empty($errors['email'])): ?>
  <?= '<p class="create-user-errors">' . $errors['email'] . '</p>'; ?>
<?php endif; ?>
...
<?php if (!empty($errors['password'])): ?>
  <?= '<p class="create-user-errors">' . $errors['password'] . '</p>'; ?>
<?php endif; ?>
...
<?php if (!empty($errors['confirmPassword'])): ?>
  <?= '<p class="create-user-errors">' . $errors['confirmPassword'] . '</p>'; ?>
<?php endif; ?>
