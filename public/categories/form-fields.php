...
<input type="text" id="category-name" name="category[name]" <?php if (isset($category) && isset($category->name)) echo 'value="' . h($category->name) . '"'; ?> required><br>


<label for="category-type">Category Type:</label><br>
<select id="category-type" name="category[category_type]">
